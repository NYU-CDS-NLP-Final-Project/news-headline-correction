...
train_bodies = pd.read_csv('/scratch/amh9750/news-headline-correction/train_bodies_preprocessed_nontokenized.csv')
...
model_name = f"bert-base-cased-news-{version}"
...
with open(f'bert_metrics_{version}.txt', 'w') as f:
...
test_results.to_csv(f'bert_test_results_{version}.csv')
