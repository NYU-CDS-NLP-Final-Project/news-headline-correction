...
train_bodies = pd.read_csv('/scratch/amh9750/news-headline-correction/train_bodies_summarized_200tok_pegasus.csv')
...
model_name = f"pegasus-200tok-summaries-bert-base-cased-news-{version}"
...
finetune_model_name = f'annabellehuether/pegasus-200tok-summaries-bert-base-cased-news-{version}'
...
with open(f'pegasus_200tok_summaries_bert_metrics_{version}.txt', 'w') as f:
...
test_results.to_csv(f'pegasus_200tok_summaries_bert_test_results_{version}.csv')
