...
train_bodies = pd.read_csv('/scratch/amh9750/news-headline-correction/train_bodies_summarized_max100tok_t5.csv')
...
model_name = f"100tok-t5-summaries-bert-base-cased-news-{version}"
...
finetune_model_name = f'annabellehuether/100tok-t5-summaries-bert-base-cased-news-{version}'
...
with open(f'100tok_t5_summaries_bert_metrics_{version}.txt', 'w') as f:
...
test_results.to_csv(f'100tok_t5_summaries_bert_test_results_{version}.csv')
