...
train_bodies = pd.read_csv('/scratch/amh9750/news-headline-correction/train_bodies_summarized_t5')
...
model_name = f"t5-summaries-bert-base-cased-news-{version}"
...
finetune_model_name = f'annabellehuether/t5-summaries-bert-base-cased-news-{version}'
...
with open(f't5_summaries_bert_metrics_{version}.txt', 'w') as f:
...
test_results.to_csv(f't5_summaries_bert_test_results_{version}.csv')
